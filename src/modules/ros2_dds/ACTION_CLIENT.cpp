...
const CStringDictionary::TStringId FORTE_ACTION_CLIENT::scm_anDataInputNames[] = {g_nStringIdSEND_GOAL_QI, g_nStringIdCANCEL_GOAL_QI, g_nStringIdGET_RESULT_QI, g_nStringIdFEEDBACK_QI, g_nStringIdTOPIC_NAME, g_nStringIdTOPIC_TYPE, g_nStringIdSEND_GOAL_REQ_DATA, g_nStringIdCANCEL_GOAL_REQ_DATA, g_nStringIdGET_RESULT_REQ_DATA};

const CStringDictionary::TStringId FORTE_ACTION_CLIENT::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdANY, g_nStringIdROS2_action_msgs__srv__CancelGoal__Request, g_nStringIdANY};

const CStringDictionary::TStringId FORTE_ACTION_CLIENT::scm_anDataOutputNames[] = {g_nStringIdSEND_GOAL_QO, g_nStringIdCANCEL_GOAL_QO, g_nStringIdGET_RESULT_QO, g_nStringIdFEEDBACK_QO, g_nStringIdSEND_GOAL_STATUS, g_nStringIdCANCEL_GOAL_STATUS, g_nStringIdGET_RESULT_STATUS, g_nStringIdFEEDBACK_STATUS, g_nStringIdSEND_GOAL_RES_DATA, g_nStringIdCANCEL_GOAL_RES_DATA, g_nStringIdGET_RESULT_RES_DATA, g_nStringIdFEEDBACK_DATA};

const CStringDictionary::TStringId FORTE_ACTION_CLIENT::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdANY, g_nStringIdROS2_action_msgs__srv__CancelGoal__Response, g_nStringIdANY, g_nStringIdANY};

const TForteInt16 FORTE_ACTION_CLIENT::scm_anEIWithIndexes[] = {-1, -1, -1, -1, -1};
const CStringDictionary::TStringId FORTE_ACTION_CLIENT::scm_anEventInputNames[] = {g_nStringIdINIT, g_nStringIdSEND_GOAL_REQ, g_nStringIdCANCEL_GOAL_REQ, g_nStringIdGET_RESULT_REQ, g_nStringIdFEEDBACK_RSP};

const TForteInt16 FORTE_ACTION_CLIENT::scm_anEOWithIndexes[] = {-1, -1, -1, -1, -1};
const CStringDictionary::TStringId FORTE_ACTION_CLIENT::scm_anEventOutputNames[] = {g_nStringIdINITO, g_nStringIdSEND_GOAL_CNF, g_nStringIdCANCEL_GOAL_CNF, g_nStringIdGET_RESULT_CNF, g_nStringIdFEEDBACK_IND};
...
const SCFB_FBConnectionData FORTE_ACTION_CLIENT::scm_astEventConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdACTION_CLIENT_SEND_GOAL, g_nStringIdINITO), 0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND, g_nStringIdEI1), 4},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdACTION_CLIENT_CANCEL_GOAL, g_nStringIdINITO), 1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND, g_nStringIdEI2), 4},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdACTION_CLIENT_GET_RESULT, g_nStringIdINITO), 2, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND_1, g_nStringIdEI1), 5},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdACTION_CLIENT_FEEDBACK_MESSAGE, g_nStringIdINITO), 3, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND_1, g_nStringIdEI2), 5},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND, g_nStringIdEO), 4, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND_2, g_nStringIdEI1), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND_1, g_nStringIdEO), 5, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND_2, g_nStringIdEI2), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_REND_2, g_nStringIdEO), 6, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdINITO), -1},
